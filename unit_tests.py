...
class TestGameFunctions(unittest.TestCase):
    ...
    def test_get_current_state(self):
        ...
        self.assertEqual(chess_board.Game("rnbqkbnr/pppp1ppp/4p3/8/8/8/PPPPPPPP/RNBQKBNR b KQkq - 0 1").get_current_state(),
                         "rnbqkbnr/pppp1ppp/4p3/8/8/8/PPPPPPPP/RNBQKBNR b KQkq - 0 1")

    def test_change_player(self):
        g = chess_board.Game()
        g.change_player()
        self.assertEqual(g.get_color(), 'b')
        g.change_player()
        self.assertEqual(g.get_color(), 'w')
    ...
    def test_get_possible_moves_for_space(self):
        ...
        # Rook at B4
        test_game = chess_board.Game("rnbqkbnr/pppppppp/8/8/1R6/8/PPPPPPPP/RNBQKBNR b KQkq - 0 1")
    ...
    def test_get_possible_moves_diagonal(self):
        ...
        test_game = chess_board.Game("rnbqkbnr/pppppppp/8/8/1B6/8/PPPPPPPP/RNBQKBNR b KQkq - 0 1")
    ...
    def test_get_possible_moves_vertical(self):
        ...
        test_game = chess_board.Game("rnbqkbnr/pppppppp/8/8/R7/8/PPPPPPPP/RNBQKBNR b KQkq - 0 1")
        self.assertItemsEqual(test_game._get_possible_moves_vertical('a4'), ['a3', 'a5', 'a6', 'a7'])

        test_game = chess_board.Game("rnbqkbnr/pppppppp/8/8/7R/8/PPPPPPPP/RNBQKBNR b KQkq - 0 1")
